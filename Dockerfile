# IsabelaOS — Worker RunPod Serverless v5
...
# Fix: symlinks para onnxruntime-gpu con CUDA 12.1
# onnxruntime busca libcublasLt.so.11 y libcufft.so.10
...
# CodeFormer
# setup.py develop genera basicsr/version.py que falta al solo clonar
